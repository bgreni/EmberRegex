"""Unicode codepoint ranges for `\\p{...}` classes.

GENERATED by tools/gen_unicode_tables.py — do not edit by hand.
Unicode 17.0, from the `regex` module (version 2026.7.19).

Each table is a flat list of inclusive [lo, hi] pairs, sorted and
coalesced. Categories and scripts come from the SAME source on
purpose — see the generator for why mixing `unicodedata` and
`regex` is a trap. `Cn` (unassigned) IS included, because
Unicode's `C` is defined to contain it and omitting it would
make `\\P{C}` match every unassigned codepoint.
"""

# --- general categories ---

comptime UC_L: List[Int] = [
    ...
    0x10EC2, 0x10EC7, 0x10F00, 0x10F1C, 0x10F27, 0x10F27, 0x10F30, 0x10F45,
    ...
    0x11D98, 0x11D98, 0x11DB0, 0x11DDB, 0x11EE0, 0x11EF2, 0x11F02, 0x11F02,
    ...
    0x16FF2, 0x16FF3, 0x17000, 0x18CD5, 0x18CFF, 0x18D1E, 0x18D80, 0x18DF2,
...
comptime UC_P: List[Int] = [
    ...
    0x10ED0, 0x10ED0, 0x10F55, 0x10F59, 0x10F86, 0x10F89, 0x11047, 0x1104D,
...
comptime UC_S: List[Int] = [
    ...
    0x20A0, 0x20C1, 0x2100, 0x2101, 0x2103, 0x2106, 0x2108, 0x2109,
    ...
    0x2B76, 0x2BFF, 0x2CE5, 0x2CEA, 0x2E50, 0x2E51, 0x2E80, 0x2E99,
    0x2E9B, 0x2EF3, 0x2F00, 0x2FD5, 0x2FF0, 0x2FFF, 0x3004, 0x3004,
    0x3012, 0x3013, 0x3020, 0x3020, 0x3036, 0x3037, 0x303E, 0x303F,
    0x309B, 0x309C, 0x3190, 0x3191, 0x3196, 0x319F, 0x31C0, 0x31E5,
    0x31EF, 0x31EF, 0x3200, 0x321E, 0x322A, 0x3247, 0x3250, 0x3250,
    ...
    0xAB6A, 0xAB6B, 0xFB29, 0xFB29, 0xFBB2, 0xFBD2, 0xFD40, 0xFD4F,
    0xFD90, 0xFD91, 0xFDC8, 0xFDCF, 0xFDFC, 0xFDFF, 0xFE62, 0xFE62,
    ...
    0x10D8E, 0x10D8F, 0x10ED1, 0x10ED8, 0x1173F, 0x1173F, 0x11FD5, 0x11FF1,
    0x16B3C, 0x16B3F, 0x16B45, 0x16B45, 0x1BC9C, 0x1BC9C, 0x1CC00, 0x1CCEF,
    0x1CCFA, 0x1CCFC, 0x1CD00, 0x1CEB3, 0x1CEBA, 0x1CED0, 0x1CEE0, 0x1CEF0,
...
comptime UC_Z: List[Int] = [
    0x20, 0x20, 0xA0, 0xA0, 0x1680, 0x1680, 0x2000, 0x200A,
    0x2028, 0x2029, 0x202F, 0x202F, 0x205F, 0x205F, 0x3000, 0x3000,
]

comptime UC_C: List[Int] = [
    0x0, 0x1F, 0x7F, 0x9F, 0xAD, 0xAD, 0x378, 0x379,
    ...
    0x85F, 0x85F, 0x86B, 0x86F, 0x890, 0x896, 0x8E2, 0x8E2,
    ...
    0x1AEC, 0x1AFF, 0x1B4D, 0x1B4D, 0x1BF4, 0x1BFB, 0x1C38, 0x1C3A,
    ...
    0x2072, 0x2073, 0x208F, 0x208F, 0x209D, 0x209F, 0x20C2, 0x20CF,
    0x20F1, 0x20FF, 0x218C, 0x218F, 0x242A, 0x243F, 0x244B, 0x245F,
    0x2B74, 0x2B75, 0x2CF4, 0x2CF8, 0x2D26, 0x2D26, 0x2D28, 0x2D2C,
    ...
    0xFB3F, 0xFB3F, 0xFB42, 0xFB42, 0xFB45, 0xFB45, 0xFDD0, 0xFDEF,
    ...
    0xFFEF, 0xFFFB, 0xFFFE, 0xFFFF, 0x1000C, 0x1000C, 0x10027, 0x10027,
    ...
    0x12544, 0x12F8F, 0x12FF3, 0x12FFF, 0x13430, 0x1343F, 0x13456, 0x1345F,
    0x143FB, 0x143FF, 0x14647, 0x160FF, 0x1613A, 0x167FF, 0x16A39, 0x16A3F,
    ...
    0x16B62, 0x16B62, 0x16B78, 0x16B7C, 0x16B90, 0x16D3F, 0x16D7A, 0x16E3F,
    ...
    0x18CD6, 0x18CFE, 0x18D1F, 0x18D7F, 0x18DF3, 0x1AFEF, 0x1AFF4, 0x1AFF4,
    ...
    0x1D379, 0x1D3FF, 0x1D455, 0x1D455, 0x1D49D, 0x1D49D, 0x1D4A0, 0x1D4A1,
    ...
    0x1D7CC, 0x1D7CD, 0x1DA8C, 0x1DA9A, 0x1DAA0, 0x1DAA0, 0x1DAB0, 0x1DEFF,
    0x1DF1F, 0x1DF24, 0x1DF2B, 0x1DFFF, 0x1E007, 0x1E007, 0x1E019, 0x1E01A,
    0x1E022, 0x1E022, 0x1E025, 0x1E025, 0x1E02B, 0x1E02F, 0x1E06E, 0x1E08E,
    ...
    0x1E4FA, 0x1E5CF, 0x1E5FB, 0x1E5FE, 0x1E600, 0x1E6BF, 0x1E6DF, 0x1E6DF,
    0x1E6F6, 0x1E6FD, 0x1E700, 0x1E7DF, 0x1E7E7, 0x1E7E7, 0x1E7EC, 0x1E7EC,
    ...
    0x1FA8B, 0x1FA8D, 0x1FAC7, 0x1FAC7, 0x1FAC9, 0x1FACC, 0x1FADD, 0x1FADE,
    0x1FAEB, 0x1FAEE, 0x1FAF9, 0x1FAFF, 0x1FB93, 0x1FB93, 0x1FBFB, 0x1FFFF,
...
comptime UC_Ll: List[Int] = [
    ...
    0x24F, 0x293, 0x296, 0x2AF, 0x371, 0x371, 0x373, 0x373,
...
comptime UC_Lo: List[Int] = [
    0xAA, 0xAA, 0xBA, 0xBA, 0x1BB, 0x1BB, 0x1C0, 0x1C3,
    0x294, 0x295, 0x5D0, 0x5EA, 0x5EF, 0x5F2, 0x620, 0x63F,
    ...
    0x889, 0x88F, 0x8A0, 0x8C8, 0x904, 0x939, 0x93D, 0x93D,
...
comptime UC_Me: List[Int] = [
    0x488, 0x489, 0x1ABE, 0x1ABE, 0x20DD, 0x20E0, 0x20E2, 0x20E4,
    0xA670, 0xA672,
]

comptime UC_Nd: List[Int] = [
...
comptime UC_Zs: List[Int] = [
    0x20, 0x20, 0xA0, 0xA0, 0x1680, 0x1680, 0x2000, 0x200A,
    0x202F, 0x202F, 0x205F, 0x205F, 0x3000, 0x3000,
]

comptime UC_Zl: List[Int] = [
    0x2028, 0x2028,
]

comptime UC_Zp: List[Int] = [
    0x2029, 0x2029,
]

comptime UC_Cc: List[Int] = [
    0x0, 0x1F, 0x7F, 0x9F,
]

comptime UC_Cf: List[Int] = [
...
comptime UC_Cs: List[Int] = [
    0xD800, 0xDFFF,
]

comptime UC_Co: List[Int] = [
    0xE000, 0xF8FF, 0xF0000, 0xFFFFD, 0x100000, 0x10FFFD,
]

comptime UC_Cn: List[Int] = [
...
comptime US_Adlam: List[Int] = [
    0x1E900, 0x1E94B, 0x1E950, 0x1E959, 0x1E95E, 0x1E95F,
]

comptime US_Arabic: List[Int] = [
    0x600, 0x604, 0x606, 0x60B, 0x60D, 0x61A, 0x61C, 0x61E,
    0x620, 0x63F, 0x641, 0x64A, 0x656, 0x66F, 0x671, 0x6DC,
    0x6DE, 0x6FF, 0x750, 0x77F, 0x870, 0x891, 0x897, 0x8E1,
    0x8E3, 0x8FF, 0xFB50, 0xFD3D, 0xFD40, 0xFDCF, 0xFDF0, 0xFDFF,
...
comptime US_Armenian: List[Int] = [
    0x531, 0x556, 0x559, 0x58A, 0x58D, 0x58F, 0xFB13, 0xFB17,
]

comptime US_Balinese: List[Int] = [
    0x1B00, 0x1B4C, 0x1B4E, 0x1B7F,
]

comptime US_Bengali: List[Int] = [
    0x980, 0x983, 0x985, 0x98C, 0x98F, 0x990, 0x993, 0x9A8,
    0x9AA, 0x9B0, 0x9B2, 0x9B2, 0x9B6, 0x9B9, 0x9BC, 0x9C4,
    0x9C7, 0x9C8, 0x9CB, 0x9CE, 0x9D7, 0x9D7, 0x9DC, 0x9DD,
    0x9DF, 0x9E3, 0x9E6, 0x9FE,
]

comptime US_Bopomofo: List[Int] = [
    0x2EA, 0x2EB, 0x3105, 0x312F, 0x31A0, 0x31BF,
]

comptime US_Braille: List[Int] = [
    0x2800, 0x28FF,
]

comptime US_Buginese: List[Int] = [
    0x1A00, 0x1A1B, 0x1A1E, 0x1A1F,
]

comptime US_Cham: List[Int] = [
    0xAA00, 0xAA36, 0xAA40, 0xAA4D, 0xAA50, 0xAA59, 0xAA5C, 0xAA5F,
]

comptime US_Cherokee: List[Int] = [
    0x13A0, 0x13F5, 0x13F8, 0x13FD, 0xAB70, 0xABBF,
]

comptime US_Coptic: List[Int] = [
    0x3E2, 0x3EF, 0x2C80, 0x2CF3, 0x2CF9, 0x2CFF,
]

comptime US_Cyrillic: List[Int] = [
    0x400, 0x484, 0x487, 0x52F, 0x1C80, 0x1C8A, 0x1D2B, 0x1D2B,
    0x1D78, 0x1D78, 0x2DE0, 0x2DFF, 0xA640, 0xA69F, 0xFE2E, 0xFE2F,
    0x1E030, 0x1E06D, 0x1E08F, 0x1E08F,
]

comptime US_Devanagari: List[Int] = [
    0x900, 0x950, 0x955, 0x963, 0x966, 0x97F, 0xA8E0, 0xA8FF,
    0x11B00, 0x11B09,
]

comptime US_Ethiopic: List[Int] = [
...
comptime US_Hebrew: List[Int] = [
    0x591, 0x5C7, 0x5D0, 0x5EA, 0x5EF, 0x5F4, 0xFB1D, 0xFB36,
    0xFB38, 0xFB3C, 0xFB3E, 0xFB3E, 0xFB40, 0xFB41, 0xFB43, 0xFB44,
    0xFB46, 0xFB4F,
]

comptime US_Hiragana: List[Int] = [
    0x3041, 0x3096, 0x309D, 0x309F, 0x1B001, 0x1B11F, 0x1B132, 0x1B132,
    0x1B150, 0x1B152, 0x1F200, 0x1F200,
]

comptime US_Javanese: List[Int] = [
    0xA980, 0xA9CD, 0xA9D0, 0xA9D9, 0xA9DE, 0xA9DF,
]

comptime US_Kannada: List[Int] = [
    0xC80, 0xC8C, 0xC8E, 0xC90, 0xC92, 0xCA8, 0xCAA, 0xCB3,
    0xCB5, 0xCB9, 0xCBC, 0xCC4, 0xCC6, 0xCC8, 0xCCA, 0xCCD,
    0xCD5, 0xCD6, 0xCDC, 0xCDE, 0xCE0, 0xCE3, 0xCE6, 0xCEF,
    0xCF1, 0xCF3,
]

comptime US_Katakana: List[Int] = [
...
comptime US_Malayalam: List[Int] = [
    0xD00, 0xD0C, 0xD0E, 0xD10, 0xD12, 0xD44, 0xD46, 0xD48,
    0xD4A, 0xD4F, 0xD54, 0xD63, 0xD66, 0xD7F,
]

comptime US_Mongolian: List[Int] = [
    0x1800, 0x1801, 0x1804, 0x1804, 0x1806, 0x1819, 0x1820, 0x1878,
    0x1880, 0x18AA, 0x11660, 0x1166C,
]

comptime US_Myanmar: List[Int] = [
    0x1000, 0x109F, 0xA9E0, 0xA9FE, 0xAA60, 0xAA7F, 0x116D0, 0x116E3,
]

comptime US_Oriya: List[Int] = [
...
comptime US_Telugu: List[Int] = [
    0xC00, 0xC0C, 0xC0E, 0xC10, 0xC12, 0xC28, 0xC2A, 0xC39,
    0xC3C, 0xC44, 0xC46, 0xC48, 0xC4A, 0xC4D, 0xC55, 0xC56,
    0xC58, 0xC5A, 0xC5C, 0xC5D, 0xC60, 0xC63, 0xC66, 0xC6F,
    0xC77, 0xC7F,
]

comptime US_Thaana: List[Int] = [
    0x780, 0x7B1,
]

comptime US_Thai: List[Int] = [
    0xE01, 0xE3A, 0xE40, 0xE5B,
]

comptime US_Tibetan: List[Int] = [
    0xF00, 0xF47, 0xF49, 0xF6C, 0xF71, 0xF97, 0xF99, 0xFBC,
    0xFBE, 0xFCC, 0xFCE, 0xFD4, 0xFD9, 0xFDA,
]

comptime US_Vai: List[Int] = [
    0xA500, 0xA62B,
]

comptime US_Yi: List[Int] = [
    0xA000, 0xA48C, 0xA490, 0xA4C6,
]

# --- shorthands ---

comptime UC_Alnum: List[Int] = [
    ...
    0x116D0, 0x116E3, 0x11700, 0x1171A, 0x1171D, 0x1171D, 0x1171F, 0x1171F,
    0x11722, 0x11725, 0x11727, 0x1172B, 0x11730, 0x1173B, 0x11740, 0x11746,
    0x11800, 0x1182B, 0x1182F, 0x11837, 0x11839, 0x1183A, 0x118A0, 0x118F2,
    0x118FF, 0x11906, 0x11909, 0x11909, 0x1190C, 0x11913, 0x11915, 0x11916,
    0x11918, 0x1192F, 0x1193B, 0x1193C, 0x1193E, 0x1193F, 0x11941, 0x11941,
    0x11943, 0x11943, 0x11950, 0x11959, 0x119A0, 0x119A7, 0x119AA, 0x119D0,
    0x119D4, 0x119D7, 0x119DA, 0x119DB, 0x119E0, 0x119E1, 0x119E3, 0x119E3,
    0x11A00, 0x11A38, 0x11A3A, 0x11A3E, 0x11A47, 0x11A47, 0x11A50, 0x11A56,
    0x11A59, 0x11A96, 0x11A98, 0x11A99, 0x11A9D, 0x11A9D, 0x11AB0, 0x11AF8,
    0x11B60, 0x11B60, 0x11B62, 0x11B64, 0x11B66, 0x11B66, 0x11BC0, 0x11BE0,
    0x11BF0, 0x11BF9, 0x11C00, 0x11C08, 0x11C0A, 0x11C2E, 0x11C30, 0x11C36,
    0x11C38, 0x11C3D, 0x11C3F, 0x11C40, 0x11C50, 0x11C6C, 0x11C72, 0x11C8F,
    ...
    0x11D67, 0x11D68, 0x11D6A, 0x11D89, 0x11D90, 0x11D91, 0x11D95, 0x11D95,
    0x11D97, 0x11D98, 0x11DA0, 0x11DA9, 0x11DB0, 0x11DDB, 0x11DE0, 0x11DE9,
    0x11EE0, 0x11EF4, 0x11F00, 0x11F02, 0x11F04, 0x11F10, 0x11F12, 0x11F33,
    0x11F36, 0x11F3A, 0x11F40, 0x11F40, 0x11F42, 0x11F42, 0x11F50, 0x11F5A,
    ...
    0x13460, 0x143FA, 0x14400, 0x14646, 0x16100, 0x16129, 0x1612D, 0x16139,
    ...
    0x16B40, 0x16B43, 0x16B50, 0x16B59, 0x16B5B, 0x16B61, 0x16B63, 0x16B77,
    0x16B7D, 0x16B8F, 0x16D40, 0x16D6C, 0x16D70, 0x16D79, 0x16E40, 0x16E96,
    0x16EA0, 0x16EB8, 0x16EBB, 0x16ED3, 0x16F00, 0x16F4A, 0x16F4F, 0x16F50,
    0x16F8F, 0x16F9F, 0x16FE0, 0x16FE1, 0x16FE3, 0x16FE4, 0x16FF2, 0x16FF6,
...
comptime UC_Space: List[Int] = [
    0x9, 0xD, 0x20, 0x20, 0x85, 0x85, 0xA0, 0xA0,
    0x1680, 0x1680, 0x2000, 0x200A, 0x2028, 0x2029, 0x202F, 0x202F,
    0x205F, 0x205F, 0x3000, 0x3000,
]

# Every table name this module defines, for the lookup in utf8.mojo.
comptime UNICODE_CATEGORY_NAMES: List[String] = [
    "L",
    "M",
    "N",
    "P",
...
comptime UNICODE_SCRIPT_NAMES: List[String] = [
    "Adlam",
    "Arabic",
    "Armenian",
    "Balinese",
