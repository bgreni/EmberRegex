...
def check(pats: List[String]) raises:
    ...
    check_lists(a.accel.states, b.accel.states, "mdfa accel")
    check_lists(a.accel.exit1, b.accel.exit1, "mdfa exit1")
    check_lists(a.accel.exit2, b.accel.exit2, "mdfa exit2")
    check_lists(a.accel.nib_states, b.accel.nib_states, "mdfa nib states")
    check_lists(a.accel.nib_kind, b.accel.nib_kind, "mdfa nib kind")
    check_lists(a.accel.nib_t0, b.accel.nib_t0, "mdfa nib t0")
    check_lists(a.accel.nib_t1, b.accel.nib_t1, "mdfa nib t1")
